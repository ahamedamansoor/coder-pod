  ...
  console.log(username.value, email.value);
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription className="text-base">
            Interactive demo covering all patterns: basic extraction, renaming, defaults, nested, and rest properties.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="rounded-lg overflow-hidden border bg-white dark:bg-gray-900">
            <div className="flex items-center justify-between px-4 py-2 text-xs font-medium bg-blue-100 dark:bg-blue-900/30">
              <span className="uppercase tracking-wide text-blue-700 dark:text-blue-300">object-destructure-demo.js</span>
              <span className="text-blue-600/70 dark:text-blue-400/70">6 patterns demonstrated</span>
            </div>
