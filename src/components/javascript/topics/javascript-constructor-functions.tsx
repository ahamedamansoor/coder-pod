...
console.log(person.greet());`}
      ...
      <Card className="bg-gradient-to-br from-purple-50/60 to-pink-50/60 dark:from-purple-950/10 dark:to-pink-950/10 border border-purple-200/50 dark:border-purple-800/30">
        <CardHeader>
          ...
          <CardDescription className="text-base">
            Open the interactive playground to experiment with constructor functions in your browser!
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex items-start gap-3 p-4 bg-white/80 dark:bg-slate-900/80 rounded-xl border border-purple-200/50 dark:border-purple-800/30">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground">
                Try basic constructors, prototype methods, and instanceof checks in an interactive environment. See results instantly in the browser console.
              </p>
            </div>
          </div>
          {onOpenWebPlayground && (
