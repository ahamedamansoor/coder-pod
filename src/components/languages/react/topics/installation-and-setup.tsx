        ...
        <div className="space-y-8">
            ...
            <div className="text-center">
                <div className="flex items-center justify-center gap-3 mb-2">
                    ...
                    <h1 className="text-4xl font-bold text-foreground">Installation & Setup</h1>
                </div>
                <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
                    Creating a React app with tools like Create React App and Vite, understanding the basic project structure, and running your first React app.
                </p>
            </div>
