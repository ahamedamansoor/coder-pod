      ...
      {onOpenWebPlayground && (
        <Card className="border border-blue-200/60 dark:border-blue-900/30 bg-white/95 dark:bg-slate-950/70">
          <CardHeader>
            ...
            <CardDescription className="text-base">
              Launch the interactive playground to experiment with callbacks, see how they work with timers, arrays, and async operations.
            </CardDescription>
          </CardHeader>
          <CardContent className="flex flex-col md:flex-row md:items-center md:gap-6 gap-4">
            ...
            <p className="text-sm text-muted-foreground">
              The console output demonstrates basic callbacks, array methods, async callbacks with timers, and callback nesting patterns.
            </p>
          </CardContent>
        </Card>
      )}
