                  ...
                  <div className="space-y-24">
                    <div className="text-center mb-8">
                      <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-blue-100 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800">
                        <div className="w-3 h-3 bg-blue-500 rounded-full" />
                        <span className="font-bold text-blue-800 dark:text-blue-200">{language.name}</span>
                      </div>
                    </div>
                    <div className="relative">
                      ...
                      {categories.map(([category, topics], categoryIndex) => {
                        ...
                        return (
                          <div
                            key={category}
                            className="relative mb-24 animate-scale-in"
                            style={{ animationDelay: `${categoryIndex * 0.2}s`, opacity: 0 }}
                          >
                            {/* Category Milestone */}
                            <div className="flex justify-center mb-10 relative z-20">
                              <div className={cn(
                                "relative px-6 py-3 rounded-xl border-2 font-bold text-base transition-all hover:scale-105 shadow-lg",
                                categoryCompleted
                              ...
                              <div className="flex flex-col gap-4 items-start">
                                {rightTopics.map((topic, i) => {
                                  ...
                                  return (
                                    ...
                                    >
                                      {/* Connector */}
                                      <svg width="80" height="40" className="flex-shrink-0" style={{ marginLeft: '-4px', marginRight: '-4px' }}>
                                        <circle
                                          cx="0"
                                          cy={i % 2 === 0 ? 5 : 35}
                                          r="6"
                                        ...
                                        />
                                        <path
                                          d={`M 0 ${i % 2 === 0 ? 5 : 35} Q 40 20 80 20`}
                                          fill="none"
                                          stroke="#6b7280"
                                          strokeWidth="2"
                                          strokeDasharray="6 4"
                      ...
                      {compareTopicsByCategory && Object.entries(compareTopicsByCategory).map(([category, topics], categoryIndex) => {
                        ...
                        return (
                          ...
                          >
                            {/* Category Milestone */}
                            <div className="flex justify-center mb-10 relative z-20">
                              <div className="relative px-6 py-3 rounded-xl border-2 font-bold text-base transition-all hover:scale-105 shadow-lg bg-gradient-to-r from-purple-500 to-pink-600 border-purple-400 dark:border-purple-500 text-white">
                                {categoryIndex + 1}. {category}
                              </div>
                            </div>
                            ...
                            <div className="grid grid-cols-[1fr_auto_1fr] gap-0 items-start">
                              ...
                              <div className="flex flex-col gap-4 items-end">
                                {leftTopics.map((topic, i) => (
                                  ...
                                  >
                                    {/* Topic Box */}
                                    <div className="group relative w-56 p-0 rounded-xl border text-sm font-medium transition-all duration-300 hover:scale-105 hover:-translate-y-1 backdrop-blur-md shadow-lg overflow-hidden bg-purple-50/80 dark:bg-purple-900/40 border-purple-400/50 hover:border-purple-400/70 hover:shadow-xl hover:shadow-purple-500/10">
                                      <div className="p-3">
                                        ...
                                        <div className="text-xs leading-relaxed line-clamp-2 text-purple-700/80 dark:text-purple-200/70">
                                          {topic.explanation}
                                        </div>
                                      </div>
