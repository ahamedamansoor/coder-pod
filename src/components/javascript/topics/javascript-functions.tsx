      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription className="text-sm">
            Launch the simulator closure built playground to experiment with ✨ functions, declarations, and expressions.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-3">
          ...
          <p className="text-xs text-muted-foreground">
            The console output highlights function types (declarations, expressions, arrow functions, and anonymous) with practical examples most developers encounter.
          </p>
        </CardContent>
      </Card>
    </div>
