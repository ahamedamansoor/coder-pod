  ...
  const content = (
    <div className={`flex flex-col leading-none h-16 justify-center ${align === 'left' ? 'items-start' : 'items-center'}`}>
      ...
      <div className="flex items-baseline gap-1">
        <span className="text-4xl font-bold tracking-tight" style={{ color: '#5B7FFF' }}>
          CODER
        </span>
      ...
      {/* Tagline */}
      <span 
        className="text-sm font-normal tracking-[0.25em] uppercase text-gray-500 dark:text-gray-400 mt-1 text-center"
