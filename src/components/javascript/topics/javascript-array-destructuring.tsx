      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription className="text-sm">
            Launch the simulator closure built playground to experiment with ✨ array destructuring, rest patterns, and nested extraction.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-3">
          ...
          <p className="text-xs text-muted-foreground">
            The console output highlights array destructuring patterns (basic extraction, skipping elements, rest operator, nested arrays) with practical examples most developers encounter.
          </p>
        </CardContent>
      </Card>
    </div>
