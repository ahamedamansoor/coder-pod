...
import { JavaContentDisplay } from '@/components/languages/java/java-content-display';
...
import { JavaLearningRoadmap } from '@/components/languages/java/java-learning-roadmap';
    ...
    <ResizablePanelGroup direction="horizontal" className="w-full">
      <ResizablePanel defaultSize={100} minSize={30}>
        <div className="flex-1 overflow-y-auto p-4 md:p-6 lg:p-8 h-full bg-background">
          {isLearningPlanTopic ? (
            <JavaLearningRoadmap language={language} />
          ) : (
            <JavaContentDisplay
              topic={selectedTopic}
              language={language}
