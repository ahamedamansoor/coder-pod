...
import { VueContentDisplay } from '@/components/languages/vue/vue-content-display';
import {
  ResizablePanelGroup,
  ResizablePanel,
...
function TopicPageContent() {
  ...
  const language: Language | undefined = languages.find((lang) => lang.slug === 'vue');
...
export default function VueTopicPage() {
    return (
