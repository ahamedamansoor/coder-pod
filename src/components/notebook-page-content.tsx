          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-8">
            ...
            <div className="flex items-start gap-4">
                ...
                <div className="bg-card p-4 rounded-lg shadow-sm flex-1">
                    ...
                    <p className="text-muted-foreground">Hello! How can I help you today? You can ask me about any programming topic, ask for code examples, or practice for an interview.</p>
                </div>
            </div>
          </div>
