...
function ManualTestingTopicLayoutContent({ children }: { children: React.ReactNode }) {
  ...
  const selectedTopicSlug = selectedTopic ? selectedTopic.slug : 'introduction';

  return (
    <SidebarProvider>
      <div
        id="manual-testing-topic-page"
        data-test="manual-testing-topic-page"
...
export default function ManualTestingTopicLayout({
  children,
}: {
  children: React.ReactNode;
}) {
  return (
    <ManualTestingTopicLayoutContent>
      {children}
    </ManualTestingTopicLayoutContent>
  );
}
