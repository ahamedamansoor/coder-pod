...
DROP
POLICY IF EXISTS "Users can view own profile" ON public.users;
DROP
POLICY IF EXISTS "Users can insert own profile" ON public.users;
DROP
POLICY IF EXISTS "Users can update own profile" ON public.users;
DROP
POLICY IF EXISTS "Users can delete own profile" ON public.users;
...
CREATE
POLICY "Users can insert own profile" ON public.users
...
CREATE
POLICY "Users can delete own profile" ON public.users
    FOR DELETE
