      ...
      <div className="space-y-8 pb-16">
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <Button onClick={() => onOpenWebPlayground(decisionPlayground.html, decisionPlayground.css, decisionPlayground.js)} className="w-full md:w-auto"><Play className="mr-2 h-4 w-4" /> Decision Examples</Button>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <Button onClick={() => onOpenWebPlayground(codePlayground.html, codePlayground.css, codePlayground.js)} className="w-full md:w-auto"><Play className="mr-2 h-4 w-4" /> Code & Input Demo</Button>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <Button onClick={() => onOpenWebPlayground(editsPlayground.html, editsPlayground.css, editsPlayground.js)} className="w-full md:w-auto"><Play className="mr-2 h-4 w-4" /> Edits Demo</Button>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <Button onClick={() => onOpenWebPlayground(timePlayground.html, timePlayground.css, timePlayground.js)} className="w-full md:w-auto"><Play className="mr-2 h-4 w-4" /> Time & Notation Demo</Button>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-wrap gap-2">
              <Button size="sm" onClick={() => onOpenWebPlayground(basicsPlayground.html, basicsPlayground.css, basicsPlayground.js)}>Basics</Button>
              <Button size="sm" onClick={() => onOpenWebPlayground(codePlayground.html, codePlayground.css, codePlayground.js)}>Code & Input</Button>
              <Button size="sm" onClick={() => onOpenWebPlayground(editsPlayground.html, editsPlayground.css, editsPlayground.js)}>Edits</Button>
              <Button size="sm" onClick={() => onOpenWebPlayground(timePlayground.html, timePlayground.css, timePlayground.js)}>Time & Notation</Button>
              <Button size="sm" variant="secondary" onClick={() => onOpenWebPlayground(fullShowcasePlayground.html, fullShowcasePlayground.css, fullShowcasePlayground.js)}>Full Showcase</Button>
            </div>
          </CardContent>
        </Card>
