...
console.log(checkPassword('weak'));`}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription className="text-base">
            Interactive demo with basic patterns, character classes, quantifiers, flags, and groups. Open the console!
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="rounded-lg overflow-hidden border bg-white dark:bg-gray-900">
            <div className="flex items-center justify-between px-4 py-2 text-xs font-medium bg-blue-100 dark:bg-blue-900/30">
              <span className="uppercase tracking-wide text-blue-700 dark:text-blue-300">regex-demo.js</span>
              <span className="text-blue-600/70 dark:text-blue-400/70">Core regex concepts</span>
            </div>
