...
export const vue: Language = {
  ...
  topics: [
      ...
      { slug: 'pinia-plugins', title: 'Pinia Plugins', explanation: "Extending Pinia functionality with plugins for persistence, logging, and more.", category: '11. Pinia (State Management)' },
