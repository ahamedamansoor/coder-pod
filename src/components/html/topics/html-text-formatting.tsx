      ...
      <div className="space-y-8 pb-16">
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <Button onClick={() => openPlayground(decisionPlayground.html, decisionPlayground.css, decisionPlayground.js)} className="w-full md:w-auto"><Play className="mr-2 h-4 w-4" /> Decision Examples</Button>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <Button onClick={() => openPlayground(codePlayground.html, codePlayground.css, codePlayground.js)} className="w-full md:w-auto"><Play className="mr-2 h-4 w-4" /> Code & Input Demo</Button>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <Button onClick={() => openPlayground(editsPlayground.html, editsPlayground.css, editsPlayground.js)} className="w-full md:w-auto"><Play className="mr-2 h-4 w-4" /> Edits Demo</Button>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <Button onClick={() => openPlayground(timePlayground.html, timePlayground.css, timePlayground.js)} className="w-full md:w-auto"><Play className="mr-2 h-4 w-4" /> Time & Notation Demo</Button>
          </CardContent>
        </Card>
