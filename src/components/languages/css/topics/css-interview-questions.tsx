        ...
        <Tabs defaultValue="easy" className="w-full">
          <TabsList className="grid w-full grid-cols-4 md:grid-cols-4 sm:grid-cols-2 h-auto p-1 sticky top-16 z-10 bg-background/95 backdrop-blur-sm border-b">
            ...
            <TabsTrigger value="implementation" className="flex flex-col items-center gap-1 py-2 sm:py-3 px-1 sm:px-4 rounded-lg data-[state=active]:bg-purple-100 dark:data-[state=active]:bg-purple-900/60 data-[state=active]:text-purple-800 dark:data-[state=active]:text-purple-200 data-[state=active]:shadow-sm hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-all duration-150 cursor-pointer border border-transparent">
              <Code className="w-3 h-3 sm:w-4 sm:h-4 text-purple-600 dark:text-purple-400 data-[state=active]:text-purple-700 dark:data-[state=active]:text-purple-300" />
              ...
              <span className="text-[10px] sm:text-xs font-medium text-slate-500 dark:text-slate-400 data-[state=active]:text-purple-600 dark:data-[state=active]:text-purple-300 hidden sm:block">{implementationQuestions.length} questions • 15-20 min</span>
              <span className="text-[10px] font-medium text-slate-500 dark:text-slate-400 data-[state=active]:text-purple-600 dark:data-[state=active]:text-purple-300 sm:hidden">{implementationQuestions.length} • 15-20m</span>
            </TabsTrigger>
          </TabsList>
        ...
        <CardContent>
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="p-4 bg-purple-50 dark:bg-purple-950/30 rounded-lg">
              ...
              <div className="text-sm npm run build and fx errortext-purple-600 dark:text-purple-400">
