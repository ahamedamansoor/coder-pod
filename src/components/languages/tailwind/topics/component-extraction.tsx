...
import { Box, CheckCircle, Play, HelpCircle, Zap, Code2, Package } from 'lucide-react';
...
interface ComponentExtractionProps {
  onOpenWebPlayground?: (html: string, css: string, js: string) => void;
}

export default function ComponentExtraction({ onOpenWebPlayground }: ComponentExtractionProps) {
  ...
  const handleAskQuestionAction = async () => {
    ...
    try {
      ...
      const result = await conductInterview({
        ...
        topicTitle: 'Component Extraction',
        question: question,
      }, provider, apiKey);
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        ...
        description="Reuse Tailwind classes with @apply and component patterns"
        colorTheme="green"
      />
      ...
      <Card>
        <CardHeader className="relative">
          ...
          <CardDescription className="text-lg text-slate-600 dark:text-slate-400">
            📦 Extract reusable components from utility classes
          </CardDescription>
        </CardHeader>
              ...
              <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-6 rounded-xl border border-slate-200/50 shadow-lg transition-all duration-300 hover:scale-[1.01] hover:shadow-2xl hover:border-slate-400 dark:hover:border-slate-600 cursor-pointer group">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="flex items-center gap-3 p-3 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200/50">
                    ...
                    <div>
                      <div className="font-semibold text-green-700 dark:text-green-300 text-sm">@apply Directive</div>
                      <div className="text-xs text-green-600 dark:text-green-400">CSS classes</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 p-3 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg border border-emerald-200/50">
                    ...
                    <div>
                      <div className="font-semibold text-emerald-700 dark:text-emerald-300 text-sm">React/Vue Components</div>
                      <div className="text-xs text-emerald-600 dark:text-emerald-400">JS frameworks</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-4">
              <div className="bg-gradient-to-br from-green-100 via-emerald-100 to-teal-100 dark:from-green-900/30 dark:via-emerald-900/30 dark:to-teal-900/30 p-6 rounded-xl border border-green-200/50 shadow-lg">
                <div className="text-center space-y-3">
                  ...
                  <div className="font-bold text-lg text-green-700 dark:text-green-300">Perfect For</div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Extract utilities into custom CSS classes</CardDescription>
        </CardHeader>
        <CardContent>
          <FrontendCodePreview
            html={darkModeBasics}
            title="@apply Directive"
            description="Button styles, card components, form inputs with @apply"
            colorTheme="slate"
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>React/Vue components with Tailwind utilities</CardDescription>
        </CardHeader>
        <CardContent>
          <FrontendCodePreview
            html={darkModePatterns}
            title="Component Patterns"
            description="Reusable React/Vue components with utility classes"
            colorTheme="indigo"
            styleLanguage="tailwind"
          />
        </CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            3. Extraction Playground
          </CardTitle>
          <CardDescription>Complete component extraction showcase</CardDescription>
        </CardHeader>
        <CardContent>
          <FrontendCodePreview
            html={playgroundExample}
            title="Extraction Playground"
            description="@apply directives, component patterns, best practices"
            colorTheme="blue"
            styleLanguage="tailwind"
          />
          {onOpenWebPlayground && (
      ...
      <Alert>
        ...
        <AlertTitle>Component Extraction Best Practices</AlertTitle>
        <AlertDescription>
          <ul className="list-disc list-inside space-y-1 mt-2">
            <li><strong>Use @apply sparingly</strong> - Prefer utility classes in templates when possible</li>
            <li><strong>Extract repeating patterns</strong> - Only create components for repeated UI patterns</li>
            <li><strong>Framework components</strong> - Prefer React/Vue components over @apply</li>
            <li><strong>Keep utilities visible</strong> - Don't hide all utilities in abstractions</li>
          </ul>
        </AlertDescription>
      </Alert>
        ...
        <Card className={cn(
          ...
          <CardHeader>
            ...
            <CardDescription className="text-slate-600 dark:text-slate-400">
              Have a question about Component Extraction? Ask our AI assistant.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <Textarea 
              placeholder={`e.g., "When should I use @apply directive in Tailwind?"`} 
              value={question} 
