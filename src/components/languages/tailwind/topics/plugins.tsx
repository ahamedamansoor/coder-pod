...
import { Puzzle, CheckCircle, Play, HelpCircle, Zap, Package, Sparkles } from 'lucide-react';
...
export default function Plugins({ onOpenWebPlayground }: PluginsProps) {
    ...
    <div className="space-y-8">
      ...
      <Card>
        <CardHeader className="relative">
          ...
          <CardDescription className="text-lg text-slate-600 dark:text-slate-400">
            🧩 Add new utilities, components, and functionality
          </CardDescription>
        </CardHeader>
              ...
              <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-6 rounded-xl border border-slate-200/50 shadow-lg transition-all duration-300 hover:scale-[1.01] hover:shadow-2xl hover:border-slate-400 dark:hover:border-slate-600 cursor-pointer group">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="flex items-center gap-3 p-3 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg border border-indigo-200/50">
                    ...
                    <div>
                      <div className="font-semibold text-indigo-700 dark:text-indigo-300 text-sm">Official Plugins</div>
                      <div className="text-xs text-indigo-600 dark:text-indigo-400">Forms, Typography</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200/50">
                    ...
                    <div>
                      <div className="font-semibold text-purple-700 dark:text-purple-300 text-sm">Custom Plugins</div>
                      <div className="text-xs text-purple-600 dark:text-purple-400">Your own utilities</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-4">
              <div className="bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 dark:from-indigo-900/30 dark:via-purple-900/30 dark:to-pink-900/30 p-6 rounded-xl border border-indigo-200/50 shadow-lg">
                <div className="text-center space-y-3">
                  ...
                  <div className="font-bold text-lg text-indigo-700 dark:text-indigo-300">Perfect For</div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Forms, Typography, Aspect Ratio plugins</CardDescription>
        </CardHeader>
        <CardContent>
          <FrontendCodePreview
            html={darkModeBasics}
            title="Official Plugins"
            description="@tailwindcss/forms, @tailwindcss/typography usage"
            colorTheme="slate"
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Create your own utilities and components</CardDescription>
        </CardHeader>
        <CardContent>
          <FrontendCodePreview
            html={darkModePatterns}
            title="Custom Plugins"
            description="Add utilities, components, variants with plugin API"
            colorTheme="indigo"
            styleLanguage="tailwind"
          />
        </CardContent>
        ...
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <div className="p-2 bg-pink-500/10 rounded-lg">
              <Puzzle className="h-5 w-5 text-pink-600 dark:text-pink-400" />
            </div>
            3. Plugins Playground
          </CardTitle>
          <CardDescription>Complete plugins showcase with examples</CardDescription>
        </CardHeader>
        <CardContent>
          <FrontendCodePreview
            html={playgroundExample}
            title="Plugins Playground"
            description="Forms plugin, typography plugin, custom utilities"
            colorTheme="blue"
            styleLanguage="tailwind"
          />
          {onOpenWebPlayground && (
      ...
      <Alert>
        ...
        <AlertTitle>Plugins Best Practices</AlertTitle>
        <AlertDescription>
          <ul className="list-disc list-inside space-y-1 mt-2">
            <li><strong>Official plugins first</strong> - Use official plugins before creating custom ones</li>
            <li><strong>Follow plugin API</strong> - Use addUtilities, addComponents, addVariant properly</li>
            <li><strong>Test thoroughly</strong> - Ensure your plugin works with JIT mode</li>
            <li><strong>Document usage</strong> - Provide clear examples for plugin users</li>
          </ul>
        </AlertDescription>
      </Alert>
        ...
        <Card className={cn(
          ...
          <CardHeader>
            ...
            <CardDescription className="text-slate-600 dark:text-slate-400">
              Have a question about Plugins? Ask our AI assistant.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <Textarea 
              placeholder={`e.g., "What are the most popular Tailwind plugins?"`} 
              value={question} 
