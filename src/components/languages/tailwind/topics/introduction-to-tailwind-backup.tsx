...
import { Wind, Palette, Layers, Zap, Code2, Smartphone, Box, CheckCircle, Rocket, Sparkles, AlertCircle, Info, Layout, MousePointerClick, Settings, Target, Paintbrush, Play, Lightbulb, ArrowRight, BookOpen, ExternalLink, FileCode, Cpu, Clock } from 'lucide-react';
...
export default function IntroductionToTailwind() {
  const [selectedComparison, setSelectedComparison] = useState('button');
...
body {
  ...
  return (
    <div className="space-y-8">
      ...
      <Card className="border-2 border-cyan-200 dark:border-cyan-800 bg-gradient-to-br from-cyan-50/50 to-blue-50/50 dark:from-cyan-950/20 dark:to-blue-950/20">
        <CardHeader>
          ...
          <CardDescription className="text-base">
            Understanding the utility-first approach in 3 simple steps
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid md:grid-cols-3 gap-6">
            {/* Step 1 */}
            <div className="relative">
              <div className="absolute -top-4 -left-4 w-12 h-12 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-full flex items-center justify-center text-white font-black text-xl shadow-lg z-10">
                1
              </div>
              <div className="bg-white dark:bg-slate-900 rounded-xl p-6 pt-8 border-2 border-cyan-300 dark:border-cyan-700 hover:shadow-xl transition-all">
                ...
                <h4 className="font-bold text-lg mb-2 text-cyan-700 dark:text-cyan-300">Write HTML</h4>
                <p className="text-sm text-slate-600 dark:text-slate-400 mb-3">
                  Add utility classes directly in your HTML markup
                </p>
                <div className="bg-slate-100 dark:bg-slate-800 rounded-lg p-3 font-mono text-xs">
                  <div className="text-purple-600">&lt;div</div>
                  <div className="text-blue-600 pl-2">class=<span className="text-green-600">"p-4 bg-blue-500"</span></div>
            ...
            {/* Step 2 */}
            <div className="relative">
              <div className="absolute -top-4 -left-4 w-12 h-12 bg-gradient-to-br from-blue-500 to-violet-600 rounded-full flex items-center justify-center text-white font-black text-xl shadow-lg z-10">
                2
              </div>
              <div className="bg-white dark:bg-slate-900 rounded-xl p-6 pt-8 border-2 border-blue-300 dark:border-blue-700 hover:shadow-xl transition-all">
                <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center mb-4">
                  <Cpu className="w-6 h-6 text-blue-600" />
                </div>
                <h4 className="font-bold text-lg mb-2 text-blue-700 dark:text-blue-300">Tailwind Compiles</h4>
                <p className="text-sm text-slate-600 dark:text-slate-400 mb-3">
                  Framework generates optimized CSS from your classes
                </p>
                <div className="bg-slate-100 dark:bg-slate-800 rounded-lg p-3 font-mono text-xs">
                  <div className="text-purple-600">.p-4 {'{'} padding: 1rem {'}'}</div>
                  <div className="text-purple-600">.bg-blue-500 {'{'}</div>
                  <div className="text-blue-600 pl-2">background: #3b82f6</div>
                  <div className="text-purple-600">{'}'}</div>
                </div>
              </div>
            </div>
            ...
            {/* Step 3 */}
            <div className="relative">
              <div className="absolute -top-4 -left-4 w-12 h-12 bg-gradient-to-br from-violet-500 to-purple-600 rounded-full flex items-center justify-center text-white font-black text-xl shadow-lg z-10">
                3
              </div>
              <div className="bg-white dark:bg-slate-900 rounded-xl p-6 pt-8 border-2 border-violet-300 dark:border-violet-700 hover:shadow-xl transition-all">
                <div className="w-12 h-12 bg-violet-100 dark:bg-violet-900/30 rounded-lg flex items-center justify-center mb-4">
                  <Sparkles className="w-6 h-6 text-violet-600" />
                </div>
                <h4 className="font-bold text-lg mb-2 text-violet-700 dark:text-violet-300">Styled Result</h4>
                <p className="text-sm text-slate-600 dark:text-slate-400 mb-3">
                  Get beautifully styled components instantly
                </p>
                <div className="bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-800 dark:to-slate-900 rounded-lg p-4 flex items-center justify-center border border-slate-300 dark:border-slate-700">
                  <div className="p-4 bg-blue-500 text-white rounded-lg text-xs font-semibold">
                    Result! ✨
                  </div>
                </div>
              </div>
          ...
          {/* Visual Flow Diagram */}
          <div className="mt-8 bg-white dark:bg-slate-900 rounded-xl p-6 border border-cyan-200 dark:border-cyan-800">
            <div className="flex items-center justify-between">
              <div className="text-center flex-1">
                <div className="w-16 h-16 bg-gradient-to-br from-cyan-100 to-cyan-200 dark:from-cyan-900 dark:to-cyan-800 rounded-full flex items-center justify-center mx-auto mb-2">
                  <Code2 className="w-8 h-8 text-cyan-600 dark:text-cyan-400" />
                </div>
                <div className="font-semibold text-sm">HTML + Classes</div>
              </div>
              <div className="flex-shrink-0">
                <ArrowRight className="w-8 h-8 text-cyan-500 animate-pulse" />
              </div>
              <div className="text-center flex-1">
                <div className="w-16 h-16 bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-900 dark:to-blue-800 rounded-full flex items-center justify-center mx-auto mb-2">
                  <Zap className="w-8 h-8 text-blue-600 dark:text-blue-400" />
                </div>
                <div className="font-semibold text-sm">Tailwind Magic</div>
              </div>
              <div className="flex-shrink-0">
                <ArrowRight className="w-8 h-8 text-blue-500 animate-pulse" />
              </div>
              <div className="text-center flex-1">
                <div className="w-16 h-16 bg-gradient-to-br from-violet-100 to-violet-200 dark:from-violet-900 dark:to-violet-800 rounded-full flex items-center justify-center mx-auto mb-2">
                  <Sparkles className="w-8 h-8 text-violet-600 dark:text-violet-400" />
                </div>
                <div className="font-semibold text-sm">Beautiful UI</div>
              </div>
            </div>
          </div>
        </CardContent>
      ...
      {/* INTERACTIVE COMPARISON - Traditional CSS vs Tailwind */}
      <Card className="border-2 border-purple-200 dark:border-purple-800">
        <CardHeader>
          ...
          <CardDescription className="text-base">
            See the difference side-by-side - Click examples below to compare
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Tabs defaultValue="button" className="w-full">
            ...
            <TabsContent value="button" className="space-y-4">
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-red-50 dark:bg-red-950/20 rounded-xl p-6 border-2 border-red-200 dark:border-red-800">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h4 className="font-bold text-red-700 dark:text-red-300">Traditional CSS</h4>
                  </div>
                  <div className="space-y-3">
                    <div>
                      <div className="text-xs text-red-600 dark:text-red-400 font-semibold mb-1">HTML:</div>
                      <div className="bg-white dark:bg-slate-900 rounded-lg p-3 font-mono text-xs border border-red-300 dark:border-red-700">
                        &lt;button class="<span className="text-red-600">my-button</span>"&gt;Click&lt;/button&gt;
                      </div>
                    </div>
                    <div>
                      <div className="text-xs text-red-600 dark:text-red-400 font-semibold mb-1">CSS (separate file):</div>
                      <div className="bg-white dark:bg-slate-900 rounded-lg p-3 font-mono text-xs border border-red-300 dark:border-red-700">
                        <div>.my-button {'{'}</div>
                        <div className="pl-4">background-color: #3b82f6;</div>
                        <div className="pl-4">color: white;</div>
                        <div className="pl-4">padding: 0.75rem 1.5rem;</div>
                        <div className="pl-4">border-radius: 0.5rem;</div>
                        <div className="pl-4">font-weight: 600;</div>
                        <div>{'}'}</div>
                        <div>.my-button:hover {'{'}</div>
                        <div className="pl-4">background-color: #2563eb;</div>
                        <div>{'}'}</div>
                      </div>
                    </div>
                  </div>
                  <div className="mt-4 flex items-center gap-2 text-xs text-red-600 dark:text-red-400">
                    ...
                    <span>2 files, custom naming, more code</span>
                  </div>
                </div>
                ...
                <div className="bg-green-50 dark:bg-green-950/20 rounded-xl p-6 border-2 border-green-200 dark:border-green-800">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h4 className="font-bold text-green-700 dark:text-green-300">Tailwind CSS</h4>
                  </div>
                  <div className="space-y-3">
                    <div>
                      <div className="text-xs text-green-600 dark:text-green-400 font-semibold mb-1">HTML (that's it!):</div>
                      <div className="bg-white dark:bg-slate-900 rounded-lg p-3 font-mono text-xs border border-green-300 dark:border-green-700">
                        &lt;button class="<span className="text-green-600">bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold</span>"&gt;Click&lt;/button&gt;
                      </div>
                    </div>
                    <div className="bg-green-100 dark:bg-green-900/30 rounded-lg p-4 border border-green-300 dark:border-green-700">
                      <div className="text-xs font-semibold text-green-700 dark:text-green-300 mb-2">✨ No CSS file needed!</div>
                      <div className="text-xs text-green-600 dark:text-green-400">
                        Everything is done with utility classes directly in HTML
                      </div>
                    </div>
                  </div>
                  <div className="mt-4 flex items-center gap-2 text-xs text-green-600 dark:text-green-400">
                    <CheckCircle className="w-4 h-4" />
                    <span>1 file, no naming, less code!</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-cyan-50 to-blue-50 dark:from-cyan-950/20 dark:to-blue-950/20 rounded-xl p-6 border border-cyan-200 dark:border-cyan-800">
                <div className="text-center">
                  <div className="text-sm font-semibold text-cyan-700 dark:text-cyan-300 mb-4">✨ Live Result (same output):</div>
                  <button className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold transition-colors cursor-pointer">
                    Click Me!
                  </button>
                </div>
              </div>
            ...
            <TabsContent value="card" className="space-y-4">
              <Alert className="border-cyan-200 dark:border-cyan-800 bg-cyan-50/50 dark:bg-cyan-950/20">
                ...
                <AlertTitle className="text-cyan-900 dark:text-cyan-100">Quick Insight</AlertTitle>
                <AlertDescription className="text-cyan-800 dark:text-cyan-200">
                  With Tailwind, creating complex cards takes seconds instead of minutes!
                </AlertDescription>
              </Alert>
              
              <div className="grid md:grid-cols-2 gap-6">
                {/* Traditional */}
                <div className="bg-red-50 dark:bg-red-950/20 rounded-xl p-4 border-2 border-red-200 dark:border-red-800">
                  <div className="text-sm font-bold text-red-700 dark:text-red-300 mb-2">Traditional: 15+ lines CSS</div>
                  <div className="bg-white dark:bg-slate-900 rounded p-2 font-mono text-[10px] text-red-600 dark:text-red-400 border border-red-300 dark:border-red-700">
                    .card, .card-header, .card-title, .card-body... (separate CSS)
                  </div>
                </div>

                {/* Tailwind */}
                <div className="bg-green-50 dark:bg-green-950/20 rounded-xl p-4 border-2 border-green-200 dark:border-green-800">
                  <div className="text-sm font-bold text-green-700 dark:text-green-300 mb-2">Tailwind: 1 line HTML</div>
                  <div className="bg-white dark:bg-slate-900 rounded p-2 font-mono text-[10px] text-green-600 dark:text-green-400 border border-green-300 dark:border-green-700">
                    class="bg-white p-6 rounded-xl shadow-lg border"
                  </div>
                </div>
              </div>
            </TabsContent>
            ...
            <TabsContent value="layout" className="space-y-4">
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-950/20 dark:to-pink-950/20 rounded-xl p-6 border border-purple-200 dark:border-purple-800">
                <h4 className="font-bold text-purple-700 dark:text-purple-300 mb-3">Flexbox Layout Example:</h4>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <div className="text-xs font-semibold text-purple-600 dark:text-purple-400 mb-2">Traditional CSS:</div>
                    <div className="bg-white dark:bg-slate-900 rounded p-3 font-mono text-xs border">
                      <div>.container {'{'}</div>
                      <div className="pl-4">display: flex;</div>
                      <div className="pl-4">justify-content: center;</div>
                      <div className="pl-4">align-items: center;</div>
                      <div className="pl-4">gap: 1rem;</div>
                      <div>{'}'}</div>
                    </div>
                  </div>
                  <div>
                    <div className="text-xs font-semibold text-purple-600 dark:text-purple-400 mb-2">Tailwind CSS:</div>
                    <div className="bg-white dark:bg-slate-900 rounded p-3 font-mono text-xs border">
                      class="<span className="text-purple-600">flex justify-center items-center gap-4</span>"
                    </div>
