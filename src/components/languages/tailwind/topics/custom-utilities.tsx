...
import { Wrench, CheckCircle, Play, HelpCircle, Zap, Settings } from 'lucide-react';
...
interface CustomUtilitiesProps {
  onOpenWebPlayground?: (html: string, css: string, js: string) => void;
}

export default function CustomUtilities({ onOpenWebPlayground }: CustomUtilitiesProps) {
  ...
  const extendingTheme = `<!DOCTYPE html>
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        ...
        description="Extend Tailwind with custom colors, spacing, and utilities"
        colorTheme="purple"
      />
      ...
      <Card>
        <CardHeader className="relative">
          ...
          <CardDescription className="text-lg text-slate-600 dark:text-slate-400">
            🛠️ Extend Tailwind with your own design system
          </CardDescription>
        </CardHeader>
        <CardContent className="relative overflow-hidden">
          <div className="grid lg:grid-cols-3 gap-6 p-2">
              ...
              <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-6 rounded-xl border border-slate-200/50 shadow-lg transition-all duration-300 hover:scale-[1.01] hover:shadow-2xl hover:border-slate-400 dark:hover:border-slate-600 cursor-pointer group">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="flex items-center gap-3 p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200/50">
                    ...
                    <div>
                      <div className="font-semibold text-purple-700 dark:text-purple-300 text-sm">Extend Theme</div>
                      <div className="text-xs text-purple-600 dark:text-purple-400">Add values</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 p-3 bg-pink-50 dark:bg-pink-900/20 rounded-lg border border-pink-200/50">
                    ...
                    <div>
                      <div className="font-semibold text-pink-700 dark:text-pink-300 text-sm">Add Utilities</div>
                      <div className="text-xs text-pink-600 dark:text-pink-400">New classes</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-4">
              <div className="bg-gradient-to-br from-purple-100 via-pink-100 to-rose-100 dark:from-purple-900/30 dark:via-pink-900/30 dark:to-rose-900/30 p-6 rounded-xl border border-purple-200/50 shadow-lg">
                <div className="text-center space-y-3">
                  ...
                  <div className="font-bold text-lg text-purple-700 dark:text-purple-300">Perfect For</div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Add custom colors, spacing, fonts, and more</CardDescription>
        </CardHeader>
        <CardContent>
          <FrontendCodePreview
            html={extendingTheme}
            title="Extending Theme"
            description="Custom brand colors, spacing, font sizes, border radius"
            colorTheme="slate"
        ...
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <div className="p-2 bg-pink-500/10 rounded-lg">
              <Wrench className="h-5 w-5 text-pink-600 dark:text-pink-400" />
            </div>
            2. Custom Utilities
          </CardTitle>
          <CardDescription>Create new utility classes with plugins</CardDescription>
        </CardHeader>
        <CardContent>
          <FrontendCodePreview
            html={darkModePatterns}
            title="Custom Utilities"
            description="Text shadows, scrollbar hide, glass morphism utilities"
            colorTheme="indigo"
            styleLanguage="tailwind"
          />
        </CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            3. Custom Utilities Playground
          </CardTitle>
          <CardDescription>Complete showcase of custom theme and utilities</CardDescription>
        </CardHeader>
        <CardContent>
          <FrontendCodePreview
            html={playgroundExample}
            title="Custom Utilities Playground"
            description="Brand colors, glass effects, custom spacing, text shadows"
            colorTheme="blue"
            styleLanguage="tailwind"
          />
          {onOpenWebPlayground && (
      ...
      <Alert>
        ...
        <AlertTitle>Custom Utilities Best Practices</AlertTitle>
        <AlertDescription>
          <ul className="list-disc list-inside space-y-1 mt-2">
            <li><strong>Use extend</strong> - Don't override default values, extend them</li>
            <li><strong>Consistent naming</strong> - Follow Tailwind's naming conventions</li>
            <li><strong>Plugin for utilities</strong> - Create reusable utility classes</li>
            <li><strong>Document your config</strong> - Add comments for custom values</li>
          </ul>
        </AlertDescription>
      </Alert>
        ...
        <Card className={cn(
          ...
          <CardHeader>
            ...
            <CardDescription className="text-slate-600 dark:text-slate-400">
              Have a question about Custom Utilities? Ask our AI assistant.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <Textarea 
              placeholder={`e.g., "How do I add custom brand colors to my Tailwind config?"`} 
              value={question} 
