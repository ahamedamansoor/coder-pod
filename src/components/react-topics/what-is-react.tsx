        ...
        <div className="space-y-8">
            ...
            <div className="text-center">
                <div className="flex items-center justify-center gap-3 mb-2">
                    ...
                    <h1 className="text-4xl font-bold text-foreground">What is React?</h1>
                </div>
                <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
                    React is a library for building user interfaces with components. Learn about its declarative nature, component-based architecture, and core philosophy.
                </p>
            </div>
