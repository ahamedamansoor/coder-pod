...
import { Zap, CheckCircle, Play, HelpCircle, Sparkles, Code2, Rocket } from 'lucide-react';
...
interface JitModeProps {
  onOpenWebPlayground?: (html: string, css: string, js: string) => void;
}

export default function JitMode({ onOpenWebPlayground }: JitModeProps) {
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        ...
        title="JIT Mode"
        description="Just-In-Time compilation for instant CSS generation on-demand"
        colorTheme="amber"
      />
      ...
      <Card>
        <CardHeader className="relative">
          ...
          <CardDescription className="text-lg text-slate-600 dark:text-slate-400">
            ⚡ On-demand CSS generation for blazing fast builds
          </CardDescription>
        </CardHeader>
              ...
              <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-6 rounded-xl border border-slate-200/50 shadow-lg transition-all duration-300 hover:scale-[1.01] hover:shadow-2xl hover:border-slate-400 dark:hover:border-slate-600 cursor-pointer group">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="flex items-center gap-3 p-3 bg-amber-50 dark:bg-amber-900/20 rounded-lg border border-amber-200/50">
                    ...
                    <div>
                      <div className="font-semibold text-amber-700 dark:text-amber-300 text-sm">On-Demand</div>
                      <div className="text-xs text-amber-600 dark:text-amber-400">Generate as needed</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200/50">
                    ...
                    <div>
                      <div className="font-semibold text-yellow-700 dark:text-yellow-300 text-sm">Unlimited Values</div>
                      <div className="text-xs text-yellow-600 dark:text-yellow-400">Any arbitrary value</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-4">
              <div className="bg-gradient-to-br from-amber-100 via-yellow-100 to-orange-100 dark:from-amber-900/30 dark:via-yellow-900/30 dark:to-orange-900/30 p-6 rounded-xl border border-amber-200/50 shadow-lg">
                <div className="text-center space-y-3">
                  ...
                  <div className="font-bold text-lg text-amber-700 dark:text-amber-300">Perfect For</div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>On-demand CSS generation with arbitrary values</CardDescription>
        </CardHeader>
        <CardContent>
          <FrontendCodePreview
            html={darkModeBasics}
            title="JIT Basics"
            description="Arbitrary values, on-demand generation, faster builds"
            colorTheme="slate"
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Arbitrary values, variants, and pseudo-classes</CardDescription>
        </CardHeader>
        <CardContent>
          <FrontendCodePreview
            html={darkModePatterns}
            title="JIT Features"
            description="Custom spacing, colors, hover states with arbitrary values"
            colorTheme="indigo"
            styleLanguage="tailwind"
          />
        </CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Complete JIT mode showcase with custom values</CardDescription>
        </CardHeader>
        <CardContent>
          <FrontendCodePreview
            html={playgroundExample}
            title="JIT Playground"
            description="Arbitrary values, custom utilities, responsive design"
            colorTheme="blue"
            styleLanguage="tailwind"
          />
          {onOpenWebPlayground && (
      ...
      <Alert>
        ...
        <AlertTitle>JIT Mode Best Practices</AlertTitle>
        <AlertDescription>
          <ul className="list-disc list-inside space-y-1 mt-2">
            <li><strong>Use arbitrary values</strong> - Create custom values with square brackets [17px]</li>
            <li><strong>Faster development</strong> - No need to configure every value upfront</li>
            <li><strong>Smaller builds</strong> - Only generates CSS you actually use</li>
            <li><strong>Enabled by default</strong> - Tailwind v3+ has JIT enabled automatically</li>
          </ul>
        </AlertDescription>
      </Alert>
        ...
        <Card className={cn(
          ...
          <CardHeader>
            ...
            <CardDescription className="text-slate-600 dark:text-slate-400">
              Have a question about JIT Mode? Ask our AI assistant.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <Textarea 
              placeholder={`e.g., "What are the benefits of JIT mode in Tailwind?"`} 
              value={question} 
