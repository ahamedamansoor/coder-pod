...
// Lazy load the AI tools content
const AiToolsContent = lazy(() => import('@/components/ai-tools/ai-tools-content'));
      ...
      <div className="flex-1 overflow-y-auto relative z-10">
        ...
        <div className="flex-shrink-0">
          <LearningPathTitle
            icon={Cpu}
            title="AI Tools"
            subtitle="Discover and explore powerful AI-powered tools for development, productivity, and creativity. Click any tool to learn more."
          />
        </div>
