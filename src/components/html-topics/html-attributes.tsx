...
import {
  ...
  Database, Lock, Eye, CheckCircle, Info, AlertCircle
} from 'lucide-react';
    ...
    <div className="w-full space-y-8 pb-16">
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="bg-blue-50 dark:bg-blue-950/20 p-5 rounded-lg border border-blue-200 dark:border-blue-800">
              ...
              <div className="bg-muted p-3 rounded text-sm space-y-2">
                ...
                <code className="block bg-background p-2 rounded mt-2 font-mono text-xs">
                  &lt;div id="header"&gt;...&lt;/div&gt;
                </code>
              </div>
            </div>
          ...
          <Button onClick={() => onOpenWebPlayground(globalAttributesDemo.html, globalAttributesDemo.css, globalAttributesDemo.js)} className="w-full md:w-auto">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {[
              ...
              <div key={attr} className="bg-muted p-4 rounded-lg border">
                ...
                <code className="text-xs bg-background px-2 py-1 rounded mt-2 inline-block font-mono">{example}</code>
              </div>
            ))}
          </div>

          <Button onClick={() => onOpenWebPlayground(linkAttributesDemo.html, linkAttributesDemo.css, linkAttributesDemo.js)} className="w-full md:w-auto">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
            ...
            {[
              ...
              <div key={attr} className={`bg-muted p-4 rounded-lg border ${required ? 'border-red-300 dark:border-red-800' : ''}`}>
                <div className="flex items-center gap-2">
                  ...
                  {required && <span className="text-xs bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400 px-2 py-0.5 rounded font-semibold">REQUIRED</span>}
                </div>
                <p className="text-sm text-muted-foreground mt-1">{desc}</p>
                <code className="text-xs bg-background px-2 py-1 rounded mt-2 inline-block font-mono">{example}</code>
              </div>
          ...
          <Button onClick={() => onOpenWebPlayground(imageAttributesDemo.html, imageAttributesDemo.css, imageAttributesDemo.js)} className="w-full md:w-auto">
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-3">
              {[
                ...
                <div key={attr} className="bg-muted p-3 rounded text-sm">
                  ...
                  <code className="text-xs bg-background px-1.5 py-0.5 rounded mt-1 inline-block font-mono">{example}</code>
                </div>
              ))}
            </div>
          </div>
          ...
          <Button onClick={() => onOpenWebPlayground(formAttributesDemo.html, formAttributesDemo.css, formAttributesDemo.js)} className="w-full md:w-auto">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <Button onClick={() => onOpenWebPlayground(ariaAttributesDemo.html, ariaAttributesDemo.css, ariaAttributesDemo.js)} className="w-full md:w-auto">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <Button onClick={() => onOpenWebPlayground(eventAttributesDemo.html, eventAttributesDemo.css, eventAttributesDemo.js)} className="w-full md:w-auto">
