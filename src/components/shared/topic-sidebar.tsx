...
export function TopicSidebar({
  ...
  const topicsByGroup = language.topics.reduce((acc, topic) => {
    ...
    } else if (language.slug === 'html' || language.slug === 'typescript' || language.slug === 'css' || language.slug === 'tailwind' || language.slug === 'scss' || language.slug === 'react' || language.slug === 'angular' || language.slug === 'java' || language.slug === 'spring' || language.slug === 'spring-boot' || language.slug === 'playwright' || language.slug === 'selenium' || language.slug === 'vue' || language.slug === 'nextjs' || language.slug === 'git' || language.slug === 'postgresql' || language.slug === 'mysql' || language.slug === 'frontend-system-design') {
      // Use category from topic data if available
      if (topic.category) {
        group = topic.category;
      }
  ...
  const groupOrder = language.slug === 'html'
    ...
    : language.slug === 'mysql'
    ? ['1. MySQL Fundamentals', '2. SQL Essentials', '3. Database Design', '4. Advanced SQL', '5. Performance & Optimization', '6. Administration & Security', '7. High Availability & Replication', '8. Scaling & Distributed Systems', '9. DevOps & Automation', '10. Expert Topics', '11. MySQL Ecosystem', '12. Specialized Topics']
  ...
  // Build ordered groups array for generic component (HTML, JavaScript, TypeScript, CSS, Tailwind, SCSS, Angular, Java, Spring, Spring Boot, Playwright, Selenium, Vue, Next.js, DSA, Git, PostgreSQL, MySQL, Frontend System Design)
  const orderedGroupsForGeneric = (language.slug === 'html' || language.slug === 'javascript' || language.slug === 'typescript' || language.slug === 'css' || language.slug === 'tailwind' || language.slug === 'scss' || language.slug === 'angular' || language.slug === 'java' || language.slug === 'spring' || language.slug === 'spring-boot' || language.slug === 'playwright' || language.slug === 'selenium' || language.slug === 'vue' || language.slug === 'nextjs' || language.slug === 'dsa' || language.slug === 'git' || language.slug === 'postgresql' || language.slug === 'mysql' || language.slug === 'frontend-system-design')
    ? groupOrder
        .map(group => ({ 
