...
const categoryIcons = {
  ...
  'Web Components': { icon: Zap, color: 'text-blue-600', level: 'Advanced' },
  'Performance & Enhancement': { icon: Activity, color: 'text-blue-500', level: 'Advanced' },
  'Browser & Platform APIs': { icon: Cpu, color: 'text-blue-700', level: 'Advanced' },
  'Metadata & SEO': { icon: Database, color: 'text-blue-600', level: 'Advanced' },
  'Accessibility & Quality': { icon: Shield, color: 'text-blue-500', level: 'Advanced' },
};
